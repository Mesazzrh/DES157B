...
function showFutureContent(contentId) {
    ...
    const bubbleAndContent = document.querySelector('.content-bubble-and-content');
    const contentBubble = document.querySelector('.content-bubble');
    const utopiaFuture = contentDiv.querySelector('.utopia');
    const dystopiaFuture = contentDiv.querySelector('.dystopia');
